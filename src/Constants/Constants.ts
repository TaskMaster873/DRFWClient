export const constants = {
    errorRequiredEmployeeNo: "Le numéro d'employé est requis",
    ...
    errorRequiredNewPassword: "Le nouveau mot de passe est requis",
    errorInvalidEmployeeNo: "Le numéro d'employé doit contenir 6 chiffres",
