...
export const errors = {
    ...
    INVALID_INITIAL_PASSWORD: "Le mot de passe initial doit contenir un minimum de 8 caractères, une minuscule, une majuscule et un caractère spécial",
    INVALID_NEW_PASSWORD: "Le nouveau mot de passe doit contenir un minimum de 8 caractères, une minuscule, une majuscule et un caractère spécial",
