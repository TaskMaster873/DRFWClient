...
export class ComponentLogin extends React.Component {
    ...
    public state: { no: any; password?: string; validated?: boolean, error: LoginFormErrorType };

    constructor(props: {} | Readonly<{}>) {
        super(props);
        this.state = { no: "", password: "", validated: false, error: LoginFormErrorType.NO_ERROR };
